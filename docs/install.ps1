...
# Download
$Archive = "gospeed_${Version}_windows_${Arch}.zip"
...
Copy-Item (Join-Path $TmpDir "gospeed.exe") -Destination $InstallDir -Force
...
Write-Host "Installed gospeed v$Version to $InstallDir\gospeed.exe"
Write-Host ""
